...
- Interceptors provide shared request IDs, verified mTLS caller identity, unary deadlines, recovery, tracing, access logs, and bounded-cardinality metrics.
...
- Register services through `ServiceRegistrar`; compose request context, optional caller identity, observability, and recovery interceptors in that order in app wiring.
