...
func NewRequestMetrics(meter appobservability.Meter) *RequestMetrics {
	...
	return &RequestMetrics{
		...
		duration:      meter.Histogram("grpc_client_request_duration_seconds", appobservability.MetricOption{Description: "Outbound gRPC request latency.", Unit: "s"}),
...
func metricFields(rpc rpcInfo, status int) appobservability.Fields {
	return appobservability.MergeFields(rpc.fields(), appobservability.FromPairs(keyGRPCStatusCode, status))
}
